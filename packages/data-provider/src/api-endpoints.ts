...
export const project = (projectId: string) => `${projects()}/${encodeURIComponent(projectId)}`;

/* Skills */
export const skills = () => `${BASE_URL}/api/skills`;
export const skill = (skillId: string) => `${skills()}/${encodeURIComponent(skillId)}`;

/* Artifacts (Persistence) */
export const artifacts = () => `${BASE_URL}/api/artifacts`;
export const artifact = (artifactId: string) => `${artifacts()}/${encodeURIComponent(artifactId)}`;
export const artifactShare = (artifactId: string) => `${artifact(artifactId)}/share`;
export const sharedArtifact = (shareId: string) => `${artifacts()}/shared/${encodeURIComponent(shareId)}`;
export const artifactVersions = (identifier: string) => `${artifacts()}/versions/${encodeURIComponent(identifier)}`;

/* Deep Research */
export const deepResearch = () => `${BASE_URL}/api/deep-research`;

/* MCP Registry */
export const mcpRegistry = () => `${BASE_URL}/api/mcp/registry`;
